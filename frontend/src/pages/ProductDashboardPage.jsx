...
const ProductDashboardPage = () => {
  ...
  const uniqueStatuses = Array.from(
    new Set(legacyProducts.map((p) => p.rationalization_status).filter(Boolean))
  ).sort();
  ...
  const filteredProducts = legacyProducts.filter((p) => {
    ...
    const statusMatch = statusFilter
      ? p.rationalization_status && p.rationalization_status.toLowerCase() === statusFilter.toLowerCase()
      : true;
  ...
  return (
    <div style={styles.container}>
      <div style={styles.card}>
        ...
        <button onClick={exportLegacyProducts} style={styles.exportButton}>
          Export
        </button>
